...
func main() {
	...
	c.Visit("https://www.immobilienscout24.de/wohnen/niedersachsen,wolfsburg.html") // what website do we want to visit/scrape

	fmt.Println(nameList)

	for _, s := range nameList {
		fmt.Println("{\"niedersachsen,\", \"wolfsburg,\", \"" + s + "\"},")
	}
}
